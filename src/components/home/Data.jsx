...
const Data = () => {
  const roles = ["Data Engineer", "Backend Developer", "Software Engineer"];
let currentRole = 0;
...
setInterval(changeRole, 2500);
  return (
   <div className="home__data">
    <h1 className="home__title"> Rahul Yenduri
    </h1>
    <h3 className="home__subtitle"><span id="role">Data Engineer</span></h3>
